...
public class ModuleThreadExecutor extends ModuleExecutor {
	...
	static Logger logger = LogManager.getLogger(ModuleThreadExecutor.class.getName());
...
//	}
	...
	public ModuleThreadExecutor(String fullyQualifiedModuleName, String jarPath) throws ModuleLoadException {
...
//	}
	...
	public static void main(String fullyQualifiedModuleName, String jarPath) throws ModuleLoadException, ModuleRuntimeException {
		ModuleExecutor executor = new ModuleThreadExecutor(fullyQualifiedModuleName, jarPath);
		executor.run();
	}
