...
\begin{document}
  ...
  framework. 
	...
	platform, the team found Maven to be a flexible and adaptable tool for
	...
	Github for a central repository over other services. Github was selected due
	to a combination of familiarity with the inner workings of Git, as well as its
